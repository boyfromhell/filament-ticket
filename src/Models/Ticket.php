...
use IchBin\FilamentTicket\Models\Scopes\AgentScope;
use Spatie\MediaLibrary\MediaCollections\Models\Media;
use IchBin\FilamentTicket\Notifications\CommentEmailNotification;

class Ticket extends Model
{
    use SoftDeletes;

    public $table = 'ticket_tickets';
    ...
    public static function boot()
    {
        ...
        Ticket::observe(new \IchBin\FilamentTicket\Observers\TicketActionObserver);
